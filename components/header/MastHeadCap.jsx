...
class MastHeadCap extends React.Component {
  handleSearch = e => {
    ...
    Router.push(`/search?searchString=${searchInput}`, `/search/${searchInput}`)
  }
  ...
  render() {
    return (
      <div>
        ...
        <form className="form-inline d-lg-inline-block d-none" id="searchBar" onSubmit={this.handleSearch}>
          <input className="form-control mr-sm-2" type="search" 
            placeholder="Search" aria-label="Search" ref={node => this.searchInput = node} />
